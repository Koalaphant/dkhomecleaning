export default function Hero() {
  return (
    <div className="relative bg-[url('/kitchen-hero.jpg')] bg-cover bg-center overflow-hidden h-[450px] sm:h-[450px] md:h-[550px] 2xl:h-[650px]">
      ...
      {/* Content Container */}
      <div className="relative z-30 text-[#105360] flex flex-col items-start justify-center px-8 sm:px-8 md:px-12 py-25 w-full max-w-6xl mx-auto h-full">
        <h1 className="text-2xl mb-4 font-merriweather">
          Welcome to DK Home Cleaning
        </h1>
        <h2 className="text-[2.2em] mb-4 font-merriweather leading-[40px]">
